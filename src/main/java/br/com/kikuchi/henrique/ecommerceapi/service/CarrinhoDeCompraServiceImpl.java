...
public class CarrinhoDeCompraServiceImpl implements CarrinhoDeCompraService {
    ...
    public List<CarrinhoDeCompra> getAllCarrinhoDeCompra() {
        if (getRoleOfUserContext().equals(ApplicationUserRole.CLIENT)){
            return carrinhoDeCompraRepository.findAllByCliente_Username(getUserOfContext().getUsername());
        };
    ...
    @Override
    public boolean hasUserCarrinhoDeCompraEmAberto(String username) {
    ...
    public void realizarCarrinhoDeCompra(Long id) {
        CarrinhoDeCompra carrinhoDeCompra = updateStatus(getCarrinhoDeCompraById(id), CarrinhoDeCompraStatus.REALIZADO);
    ...
    public void cancelarCarrinhoDeCompra(Long id) {
        CarrinhoDeCompra carrinhoDeCompra = updateStatus(getCarrinhoDeCompraById(id), CarrinhoDeCompraStatus.CANCELADO);
        carrinhoDeCompraRepository.saveAndFlush(carrinhoDeCompra);
    }
